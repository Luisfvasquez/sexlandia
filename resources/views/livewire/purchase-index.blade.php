            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($purchases as $purchase)
                        ...
                        <tr wire:key="purchase-{{ $purchase->id }}" x-data="{ openDetail: false }" class="hover:bg-gray-50 transition-colors">
                        ...
                        <tr>
                            <td colspan="8" class="px-6 py-12 text-center text-gray-500">
                                No se han encontrado compras con ese criterio. <a
                                    ...
                                    class="text-blue-600 hover:underline font-medium">Registra una nueva compra.</a>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
